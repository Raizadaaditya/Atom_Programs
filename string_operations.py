...
print(
    "greeting_statement[0]: (first character of greeting statement) "+greeting_statement[0])

# fourth character of greeting statement
print(
    "greeting_statement[3]: (fourth character of greeting statement) "+greeting_statement[3])
...
print(
    "greeting_statement[-3]: (third-last character) " + greeting_statement[-3])

# Displays the string from Index 1 to 4
print(
    "greeting_statement[1:4]: (Displays the string from Index 1 to 4) " + greeting_statement[1:4])

# Displays the sub string from first character till index 2 (ie, third character)
print(
    "greeting_statement[:2]: (Displays the string from first character till index 2 (ie, third character)::" + greeting_statement[:2])

# Displays the sub string from index =2  till the end
print(
    "greeting_statement[:2]: (Displays the sub string from index =2  till the end)::" + greeting_statement[2:])
